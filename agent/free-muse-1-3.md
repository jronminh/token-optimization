---
description: Read-only trial agent running the free model opencode/muse-spark-1.3-contributor-free. Use ONLY through the free-model-first policy to attempt a task before the paid main model is spent.
mode: all
