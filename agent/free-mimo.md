---
description: Read-only trial agent running the free model opencode/mimo-v2.5-free. Use ONLY through the free-model-first policy to attempt a task before the paid main model is spent.
mode: all
