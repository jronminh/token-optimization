---
description: Trial agent running the free model opencode/minimax-m3-free. It may edit/write files and run a limited command set. Use ONLY through the free-model-first policy to attempt a task before the paid main model is spent.
mode: all
