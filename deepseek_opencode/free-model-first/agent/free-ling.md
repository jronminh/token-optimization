---
description: Trial agent running the free model opencode/ling-3.0-flash-fin-free. It may edit/write files and run a limited command set. Use ONLY through the free-model-first policy to attempt a task before the paid main model is spent.
mode: all
